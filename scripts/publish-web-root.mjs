...
const routes = [
  ...
  },
  {
    ...
    description: "Private delivery of a DayTradingBot activation code and installer after confirmed payment.",
  ...
  },
  {
    ...
    description: "DayTradingBot license terms, bot choice, risk acknowledgement, one-device use, and refunds.",
