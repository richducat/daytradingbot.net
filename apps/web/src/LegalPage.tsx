const legalPages = {
  ...
  "/privacy/": {
    ...
    sections: [
      ...
      ["Purchase and delivery data", "After payment, the buyer's email, Stripe checkout identifier, and encrypted license-delivery record are stored so the activation code and app can be delivered. The purchase flow does not ask for a broker password, account number, or trading credentials."],
